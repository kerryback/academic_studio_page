...
- [macOS (Apple Silicon)](https://github.com/kerryback/academic_studio/releases/latest/download/Academic-Studio-macos-arm64.dmg) --- Apple Silicon only; does not run on older Macs with Intel chips
